...
**Transcript source**:
Which of the four fallback tiers produced a given Transcript — public captions, owned-channel API, extractor, or audio transcription — carried as provenance so the summarizing agent can flag lower-confidence transcripts (e.g. machine-transcribed audio).
